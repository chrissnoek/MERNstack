...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "e6061f652a894c22a4a9";
...
class About extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  constructor(props) {
    ...
    const apiAbout = _store_js__WEBPACK_IMPORTED_MODULE_1__["default"].initialData ? _store_js__WEBPACK_IMPORTED_MODULE_1__["default"].initialData : null;
...
class DateInput extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  onBlur(e) {
    ...
    const dateValue = unformat(value); // set valid to true, when value is empty or dateValue is not null
  ...
  render() {
    ...
    const {
      ...
      onValidityChange,
      ...props
    } = this.props; // only show the user-typed-in value (value)  if the value is invalid, or editing it
...
class IssueAddNavItem extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    this.state = {
      showing: false,
...
class IssueEdit extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  async handleSubmit(e) {
    ...
    const {
      issue,
      invalidFields
    } = this.state; // count the length of keys in invalidFields object, if so there are invalid fiels
...
class IssueFilter extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  onChangeEffortMax(e) {
    const effortString = e.target.value; //check if the value can be converted to a digit characters (\d), before updating the state
...
class IssueList extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  async closeIssue(index) {
    ...
    if (data) {
      this.setState(prevState => {
        ...
        const newList = [...prevState.issues]; // replace the issue with updated data
  ...
  async deleteIssue(index) {
    ...
    if (data && data.issueDelete) {
      this.setState(prevState => {
        // make a copy of the previous state
        const newList = [...prevState.issues]; // if an issue is selected
        ...
        this.showSuccess(`Deleted issue ${id} successfully.`); // return the new issuelist to set state function
  ...
  render() {
    ...
    }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_IssueDetail_jsx__WEBPACK_IMPORTED_MODULE_3__["default"], {
      issue: selectedIssue
...
const IssueRow = Object(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["withRouter"])(({
  ...
  deleteIssue,
  // this is a function passed by issueList
  closeIssue,
  // this is a function passed by issueList
...
class NumInput extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(); // set the state with a string value
...
/* harmony import */ var react_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-icons */ "react-icons");
...
async function graphQLFetch(query, variables = {}, showError = null) {
  ...
  try {
    ...
    const result = JSON.parse(body, jsonDateReviver); // alert the error message when the result is containing erros
